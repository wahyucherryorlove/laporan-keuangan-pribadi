                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php if (($_SESSION['roles'] === "Administrasi") || ($_SESSION['roles'] === "Petugas")) : ?>
                                            <td>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#edit<?= $item['id'] ?>" class="btn btn-sm btn-warning">Edit</a> || <a data-href="data-pengeluaran.php?delete=<?= $item['id']; ?>" id="delete" class="delete btn-sm btn-danger btn">Delete</a>
                                            </td>
                                        <?php endif; ?>
                                    </tr>
                                <?php endwhile; ?>
